...
% didactic places every \autocite in the margin as a float; a
% citation-dense paragraph next to a table float exhausts the kernel's
% default float registers ("Too many unprocessed floats"), so give it
% more.
\extrafloats{200}
