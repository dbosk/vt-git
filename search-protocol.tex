...
students use GitHub \autocite{Tiwari2022GitHubSurvey}; a live
skill checkoff in which students demonstrate Git to a teaching
assistant, with confidence surveyed alongside
\autocite{McMahon2026Checkoffs}; the split-view tool's mixed performance
gains \autocite{Bucher2026GitTakesTwo}; and repository metrics and
process mining, for grading or for behaviour
